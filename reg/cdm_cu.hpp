...
{
template
void cdm_cuda<tipl::out,unsigned char,3>(const std::vector<tipl::const_pointer_image<3,unsigned char> >& It,
...
template
void cdm_cuda<tipl::out,unsigned char,2>(const std::vector<tipl::const_pointer_image<2,unsigned char> >& It,
